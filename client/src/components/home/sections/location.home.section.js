...
export default function LocationHomeSection({ contact }) {
  const address = `${contact.address.line1}, ${contact.address.zipCode} ${contact.address.city}`;
  return (
    <section className="location" aria-labelledby="location-title">
      <div className="location-inner page-container">
        ...
        <div className="location-copy"><p className="eyebrow">NOTRE ADRESSE</p><h2 id="location-title">Sur les quais<br /><em>du Tarn.</em></h2><p>Retrouvez-nous au {address}, à deux pas du centre historique de Montauban, dans un cadre unique.</p><Link href="/contact" className="button button--dark">Nous trouver <span><ArrowIcon size={22} /></span></Link><div className="location-words"><span>TARN</span><span>PATRIMOINE</span><span>GASTRONOMIE</span><span>ART DE VIVRE</span></div></div>
